<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-05-15 23:09:58
        ...
        <div class="col-sm-12  col-md-12  main">
          ...
          <form class="form-horizontal" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
              <input id="pass" name="pass" type="password"  minlength="5" title="5 letras mín." class="form-control input-md" >
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
              <input id="pass2" name="pass2" placeholder="CAMPO REQUERIDO" type="password"  minlength="5" title="5 letras mín." class="form-control input-md" required="" >
